...
public class Receipt {
    ...
    private void login() throws InvalidPasswordException, MaximumLoginAttemptsExceededException {
        int attempts = 0;
        ...
        throw new MaximumLoginAttemptsExceededException("Maximum login attempts exceeded.");
    }
    ...
    private void mainMenu() {
        while (true) {
            ...
            } catch (InvalidOptionException | MaximumItemsReachedExceededException | InsufficientAmountException e) {
                System.out.println(e.getMessage());
            }
        }
    }

    private void handleAddItem() throws MaximumItemsReachedExceededException {
    ...
    private void handleMakePayment() throws InsufficientAmountException {
        calculateTotalDue();
        displayItems();

        double amountGiven = inputDouble("Enter amount given by customer: ");
        if (amountGiven < totalDue) {
            throw new InsufficientAmountException("Insufficient amount. Payment failed.");
        }
